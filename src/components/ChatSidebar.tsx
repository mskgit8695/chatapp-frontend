        ...
        <div className="flex items-center justify-between">
          ...
          <button
            className={`p-2.5 rounded-lg transition-colors ${
              showAllUsers
                ? "bg-red-60 hover:bg-red-700 text-white"
        ...
        {showAllUsers ? (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="relative">
                        ...
                        {
                          /* to display online symbol */
                          onlineUsers.includes(u._id) && (
                            <span className="absolute -top-0.5 -right-0.5 w-3.5 h-3.5 rounded-full border-2 bg-green-500 border-gray-900" />
                          )
                        }
                      </div>
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-xs text-gray-400 mt-0.5">
                          {
                            /* to display online or offline text */
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        {unseenCount > 0 && (
                          <div className="flex items-center justify-center font-bold bg-red-600 text-white text-xs rounded-full min-w-5.5 h-5.5 px-2">
          ...
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <p className="text-sm text-gray-500 mt-1">
              Start a new chat to begin sending messages!
            </p>
          </div>
        )}
      </div>

  ...
  const submitHandler = async (e: any) => {
    ...
    try {
      ...
      const { data } = await axios.post(
        `${user_service}/api/v1/users/${user?._id}`,
        {
          name,
        },
        {
          ...
          <div className="bg-gray-700 p-8 border-b border-gray-600">
            <div className="flex items-center gap-6">
              <div className="relative">
                ...
                <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-gray-500 rounded-full border-2 border-gray-800"></div>
              </div>
                ...
                {isEdit ? (
                  <form onSubmit={submitHandler} className="space-y-4">
                    ...
                    <div className="flex gap-3">
                      <button
                        type="submit"
                        className="flex items-center gap-2 px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg"
                      >
                      ...
                      <button
                        type="button"
                        onClick={editHandler}
                        className="flex items-center gap-2 px-6 py-2 bg-gray-600 hover:bg-gray-700 text-white font-semibold rounded-lg"
                      >
                        Cancel
                      </button>
                    </div>
